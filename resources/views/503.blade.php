...
<link rel="stylesheet" href="../../public/assets/css/style.css">
    <link rel="preload" href="../../public/assets/fonts/source-sans-pro-v21-latin/source-sans-pro-v21-latin-regular.woff2" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="../../public/assets/fonts/source-sans-pro-v21-latin/source-sans-pro-v21-latin-700.woff2" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="../../public/assets/fonts/montserrat-v25-latin/montserrat-v25-latin-700.woff2" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="../../public/assets/fonts/montserrat-v25-latin/montserrat-v25-latin-600.woff2" as="font" type="font/woff2" crossorigin>

<link rel="preload" href="../../public/assets/fonts/material-icons/material-icons.woff2" as="font" type="font/woff2" crossorigin>
<link rel="preload" href="../../public/assets/fonts/material-icons/material-icons-outlined.woff2" as="font" type="font/woff2" crossorigin>
        ...
        <div class="container">
            <div class="row flex-nowrap align-items-center justify-content-between">
                <div class="col-auto header-fixed-col logo-wrapper">
                    <a href="index.blade.php" class="logo" title="PathSoft">
                        <img src="../../public/assets/img/logo.svg" width="115" height="36" alt="PathSoft">
                    </a>
                </div>
...
<nav class="main-mnu">
    <ul class="main-mnu-list">
        <li>
            <a href="index.blade.php" data-title="Home">
                <span>Home</span>
            </a>
        </li>
        <li>
					...
					<div class="row">
						<div class="col-12">
							...
							<div class="btn-group align-items-center justify-content-center">
								<a href="index.blade.php" class="btn btn-with-icon ripple">
									<span>Go to home page</span>
									<svg class="btn-icon-right" viewBox="0 0 13 9" width="13" height="9">
										<use xlink:href="assets/img/sprite.svg#arrow-right"></use>
									</svg>
								</a>
								<a href="contacts.blade.php" class="btn btn-border btn-with-icon ripple">
                ...
                <div class="col-lg-3 col-md-4 col-12 item">
                    <div class="widget-brand-info">
                        <div class="widget-brand-info-main">
                            <a href="index.blade.php" class="logo" title="PathSoft">
                                <img data-src="assets/img/logo-white.svg" class="lazy" width="133" height="36" src="../../public/assets/img/logo-white.svg" alt="PathSoft" data-loaded="true" style="opacity: 1;">
                            </a>
                        </div>
                    </div>
                </div>
...
<script src="../../public/assets/libs/lozad/lozad.min.js"></script>
<script src="../../public/assets/libs/device/device.js"></script>
<script src="../../public/assets/libs/spincrement/jquery.spincrement.min.js"></script>
<script src="../../public/assets/libs/pristine/pristine.min.js"></script>
