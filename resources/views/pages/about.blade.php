                ...
                <div class="col-12">
                    <div class="content">
                        ...
                        <p>Welcome to our wonderful world. We sincerely hope that each and every user entering our website
                            ...
                            from one page to another with a single mouse click. We use only trusted, verified content.</p>
            ...
            <div class="row items">
                <div class="col-12">
                    <div class="section-heading heading-center">
                        ...
                        <h2>Our customers</h2>
                        <p class="section-desc">Our customers have disrupted industries, opened new markets, and made
                            countless lives better. We are privileged to work with hundreds of future-thinking businesses,
                            including many of the world’s top hardware, software, and consumer brands.</p>
                    </div>
                </div>
