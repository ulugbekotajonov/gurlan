    ...
    <div class="main-inner">
        ...
        <nav class="mmm">
            <div class="mmm-content">
                <ul class="mmm-list">
                    ...
                    <li>
                        <a href="tabs.blade.php">Tabs & Accordions</a>
                    </li>
                    <li>
                        <a href="news.blade.php">News</a>
                    </li>
                    <li>
                        <a href="contacts.blade.php">Contacts</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="section-bgc intro">
            <div class="intro-item intro-item-type-1"
                 style="background-image: url('../../public/assets/img/intro-img1.jpg');">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="intro-content" style="--margin-left: 4rem;">
                                <div class="section-heading shm-none">
                                    ...
                                    <p class="section-desc">The free template is the simplified version of the premium
                                        template, but you can use it for your own purposes. The premium template
                                        includes a lot of functionality.</p>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 item">
                        <a href="#!" class="iitem item-style iitem-hover">
                            ...
                            <div class="iitem-desc">Contrary to popular belief, Lorem Ipsum is not simply random text.
                    ...
                    <div class="col-lg-4 col-md-12 col-12 item">
                        <a href="#!" class="iitem item-style iitem-hover">
                            ...
                            <div class="iitem-desc">There are many variations of passages of Lorem Ipsum available, but
                    ...
                    <div class="col-lg-4 col-md-6 col-12 litem">
                        <div class="ini">
                            ...
                            <div class="ini-info">
                                ...
                                <div class="ini-desc">
                                    <p>You can rely on our 24/7 tech support that will gladly solve any app issue you
                                        may have.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 item">
                        <div class="reviews-item item-style">
                            ...
                            <div class="reviews-item-text">
                                <p>PathSoft offers a high caliber of resources skilled in Microsoft Azure.NET, mobile
                    ...
                    <div class="col-lg-4 col-md-6 col-12 item">
                        <div class="reviews-item item-style">
                            ...
                            <div class="reviews-item-text">
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit consequuntur sequi
                                    eos beatae deleniti culpa cupiditate rerum. Similique, blanditiis rem perspiciatis
                                    fugiat voluptatem quas officiis ducimus reprehenderit.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12 col-12 item">
                        <div class="reviews-item item-style">
                            ...
                            <div class="reviews-item-text">
                                <p>We sincerely hope that each and every user entering our website will find exactly.
                                    With advanced features of activating account and new login widgets, you will
                                    definitely have a great experience of using our web page.</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row items">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 item">
                        <article class="news-item item-style">
                            ...
                            <div class="news-item-info">
                                ...
                                <h3 class="news-item-heading item-heading">
                                    <a href="post.blade.php" title="Key Considerations Of IPaaS">Key Considerations Of
                                        IPaaS</a>
                                </h3>
                                <div class="news-item-desc">
                    ...
                    <div class="col-lg-4 col-md-6 col-12 item">
                        <article class="news-item item-style">
                            ...
                            <div class="news-item-info">
                                ...
                                <h3 class="news-item-heading item-heading">
                                    <a href="post.blade.php" title="Hibernate Query Language">Hibernate Query
                                        Language</a>
                                </h3>
                                <div class="news-item-desc">
                    ...
                    <footer class="section-footer col-12 item section-footer-animate">
                        <div class="btn-group align-items-center justify-content-center">
                            <a href="news.blade.php" class="btn btn-with-icon btn-w240 ripple">
                            ...
                            <div class="widget-brand-info-main">
                                <a href="index.html" class="logo" title="PathSoft">
                                    <img data-src="assets/img/logo-white.svg" class="lazy" width="133" height="36"
                                         src="../../public/assets/img/logo-white.svg" alt="PathSoft" data-loaded="true"
                                         style="opacity: 1;">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="footer-item">
                            <nav class="footer-nav">
                                <ul class="footer-mnu footer-mnu-line">
                                    ...
                                    <li><a href="#!" class="hover-link" data-title="About us"><span>About us</span></a>
                                    </li>
                                    <li><a href="#!" class="hover-link" data-title="Services"><span>Services</span></a>
                                    </li>
                                    <li><a href="#!" class="hover-link" data-title="News"><span>News</span></a></li>
                                    <li><a href="#!" class="hover-link" data-title="Contacts"><span>Contacts</span></a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
